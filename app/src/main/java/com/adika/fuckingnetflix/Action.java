    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ii1 = new Intent(Action.this, Vikings.class);
                startActivity(ii1);
            }
        });
        i2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ii2 = new Intent(Action.this, The100.class);
                startActivity(ii2);
            }
        });
        i3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ii3 = new Intent(Action.this,Hawaiifiveo.class );
                startActivity(ii3);
            }
        });
        i4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ii4 = new Intent(Action.this, BlackList.class);
                startActivity(ii4);
            }
        });
    }
            ...
            final FirebaseAuth.AuthStateListener authListener = new FirebaseAuth.AuthStateListener() {
                ...
                public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                    ...
                    if (user == null) {
                        ...
                        startActivity(new Intent(Action.this, LoginActivity.class));
